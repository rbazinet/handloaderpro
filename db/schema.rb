...
ActiveRecord::Schema[8.1].define(version: 2025_09_13_023936) do
  ...
  create_table "cartridge_type_bullet_weights", force: :cascade do |t|
    t.bigint "bullet_weight_id", null: false
    t.bigint "cartridge_type_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bullet_weight_id"], name: "index_cartridge_type_bullet_weights_on_bullet_weight_id"
    t.index ["cartridge_type_id", "bullet_weight_id"], name: "index_cartridge_type_bullet_weights_unique", unique: true
    t.index ["cartridge_type_id"], name: "index_cartridge_type_bullet_weights_on_cartridge_type_id"
  end

  create_table "cartridge_type_cartridges", force: :cascade do |t|
    t.bigint "cartridge_id", null: false
    t.bigint "cartridge_type_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cartridge_id"], name: "index_cartridge_type_cartridges_on_cartridge_id"
    t.index ["cartridge_type_id", "cartridge_id"], name: "index_cartridge_type_cartridges_unique", unique: true
    t.index ["cartridge_type_id"], name: "index_cartridge_type_cartridges_on_cartridge_type_id"
  end

  create_table "cartridge_type_manufacturers", force: :cascade do |t|
    t.bigint "cartridge_type_id", null: false
    t.datetime "created_at", null: false
    t.bigint "manufacturer_id", null: false
    t.datetime "updated_at", null: false
    t.index ["cartridge_type_id", "manufacturer_id"], name: "index_cartridge_type_manufacturers_unique", unique: true
    t.index ["cartridge_type_id"], name: "index_cartridge_type_manufacturers_on_cartridge_type_id"
    t.index ["manufacturer_id"], name: "index_cartridge_type_manufacturers_on_manufacturer_id"
  end
  ...
  add_foreign_key "cartridge_type_bullet_weights", "cartridge_types"
  add_foreign_key "cartridge_type_cartridges", "cartridge_types"
  add_foreign_key "cartridge_type_cartridges", "cartridges"
  add_foreign_key "cartridge_type_manufacturers", "cartridge_types"
  add_foreign_key "cartridge_type_manufacturers", "manufacturers"
